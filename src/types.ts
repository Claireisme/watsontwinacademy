...
export interface Enquiry { id: string; reference?: string|null; parent_name: string; email: string; phone: string; age_group: string; course_id: string | null; message: string; status: string; created_at: string; course_title?: string; mail_status?: string; attempts?: number; last_error?: string }
